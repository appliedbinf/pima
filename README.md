...
## Significant changes <!-- omit in toc -->

### Fast5 / pod5 files <!-- omit in toc -->
...
### ONT watch commands <!-- omit in toc -->
...
### Estimating the input genome size <!-- omit in toc -->
...
### ONT assembly options <!-- omit in toc -->
...
### Parallelizing PiMA on HPCs <!-- omit in toc -->
...
### Parallelizing PiMA on local machines <!-- omit in toc -->
...
### Calling AMR-conferring variants <!-- omit in toc -->
...
#### Calling AMR-conferring INDELS <!-- omit in toc -->
...
### Changes to the report <!-- omit in toc -->
...
### Singularity container <!-- omit in toc -->
...
## Install using a singularity container <!-- omit in toc -->
